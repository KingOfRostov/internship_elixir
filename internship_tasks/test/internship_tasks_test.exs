defmodule InternshipTasksTest do
  ...
  test "greets new employee" do
    ...
    assert HrBot.hello("Марина", "Швея") == "Поприветствуйте Марину, нашу новую Швею!"
    assert HrBot.hello("Аня", "парикмахер") == "Поприветствуйте Аню, нашего нового парикмахера!"
    assert HrBot.hello("Света", "Кассирша") == "Поприветствуйте Свету, нашу новую Кассиршу!"
  end
